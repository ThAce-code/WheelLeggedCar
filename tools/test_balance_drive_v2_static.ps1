...
Assert-Contains "project/code/telemetry.c" 'float vofa_data\[58\]' "Telemetry must emit 58-channel fast diagnostics frame."
Assert-Contains "tools/collect_balance_data.ps1" '\$FloatCount = 58' "Collector must parse 58-channel telemetry."
