...
Assert-Near $frames[0].right_motor_rpm 48.0 0.001 "right_motor_rpm"
Assert-Near $frames[0].left_motor_rpm 47.0 0.001 "left_motor_rpm"
Assert-Near $frames[0].right_duty -120.0 0.001 "right_duty"
Assert-Near $frames[0].left_duty -118.0 0.001 "left_duty"
