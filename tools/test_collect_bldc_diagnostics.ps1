...
Assert-Near $frames[0].right_motor_rpm 48.0 0.001 "right rpm"
Assert-Near $frames[0].left_motor_rpm 47.0 0.001 "left rpm"
Assert-Near $frames[0].right_duty -120.0 0.001 "right duty"
