...
Assert-Contains "project/code/control_leg.c" "10\.0f \* progress \* progress \* progress" "Fast height mode must use a quintic no-overshoot blend."
...
Assert-Contains "project/code/actuator_servo.h" "actuator_servo_apply_immediate" "Direct-step mode must expose immediate PWM output."
...
Assert-Contains "project/code/control_leg.c" "LEG_MODE_DIRECT_STEP[\s\S]*actuator_servo_apply_immediate" "Direct-step mode must bypass PWM slew."
