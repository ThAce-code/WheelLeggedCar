...
Assert-Contains "project/code/control_leg.c" "LEG_MODE_FAST_HEIGHT[\s\S]*actuator_servo_set_speed_limit\(APP_LEG_FAST_SERVO_MAX_SPEED_DPS\)" "Only fast height mode may select the 180 dps servo slew cap."
Assert-Contains "project/code/control_leg.c" "else[\s\S]*actuator_servo_set_speed_limit\(APP_SERVO_MAX_SPEED_DPS\)" "Non-fast leg modes must restore the 90 dps servo slew cap."
...
Assert-Contains "project/code/actuator_servo.h" "actuator_servo_set_speed_limit" "Servo module must expose a scoped slew-limit API."
...
Assert-Contains "project/code/actuator_servo.c" "actuator_servo_speed_limit_dps" "Servo module must retain its active slew limit."
