...
Assert-Contains "project/code/leg_config.c" "high_height_mm = 80\.0f" "Phase 1 high command must stay inside the measured monotonic height interval."
Assert-Contains "project/code/leg_config.c" "default_height_mm = 35\.0f" "Phase 1 default command must start near the measured safe pose."
Assert-Contains "project/code/leg_config.c" "safe_support_height_mm = 35\.0f" "LOCK-to-height transition must restart from the mapped Phase 1 safe command."
...
Assert-Contains "docs/leg-height-phase1-hardware-test.md" "35 / 55 / 80" "Hardware Gate 1 must use the measured monotonic Phase 1 height commands."
