...
Assert-Contains "project/code/telemetry.c" "float vofa_data\[40\]" "Telemetry must emit 40 floats."
Assert-Contains "tools/collect_balance_data.ps1" "\$FloatCount = 40" "Collector must parse 40 floats."
Assert-Contains "tools/calib_ik_servo.ps1" "\$FloatCount = 40" "Calibration tool must parse 40 floats."
